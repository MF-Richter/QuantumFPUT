...
with two oppositely displaced normal mode coherent states, for a FPUT chain. The two
trajectories are saved in data/KetTrajectories for further processing.
"""
